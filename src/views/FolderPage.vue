    ...
    <ion-content :fullscreen="true">
        ...
        <ion-card>
          ...
          <ion-card-content>
            ...
            <p
              ...
              v-if="DataAnswereService.drive != null"
            >
              ...
              <ion-chip color="dark">
                ...
                <ion-badge color="primary"
                  >{{ JSON.parse(DataAnswereService.drive).comentarios.length }}
                </ion-badge>
              </ion-chip>
              <ion-chip color="primary">
                <ion-icon name="car-outline"></ion-icon>
                <ion-badge color="primary"
                  >{{ JSON.parse(DataAnswereService.drive).count_drives }}
                </ion-badge>
              </ion-chip>
            </p>
      ...
      <div id="container" style="width: 100%; height: 100%; z-index: 1">
        ...
        <div class="float-div-mapper">
          <ion-button color="warning" id="open-modal"  expand="block">
            ¿A donde quieres ir?
          </ion-button>
        </div>
      </div>
